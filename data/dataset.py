...
def get_rnn_corpus():
    ...
    return torch.tensor(train_df['tokens'].to_list()), torch.tensor(train_df['toxic'].to_list()), \
           torch.tensor(val_df['tokens'].to_list()), torch.tensor(val_df['toxic'].to_list()), \
           torch.tensor(test_df['tokens'].to_list()), torch.tensor(test_df['toxic'].to_list())
